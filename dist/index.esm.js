...
var Button = function (props) {
    return (jsx(StyledButton, __assign({ variant: props.variant, color: props.color, height: height[props.size], disabled: props.disabled, onClick: props.onClick }, { children: props.children }), void 0));
};
Button.defaultProps = {
    variant: "text",
    color: "default",
...
var StyledButton = styled.button(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  // common\n  border-radius: ", ";\n  border: 1px solid transparent;\n  padding: 0 ", ";\n  height: ", "px;\n  font-size: ", ";\n  font-weight: ", ";\n  :disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n\n  // default\n  ", "\n\n  // primary\n  ", "\n\n  // secondary\n  ", "\n"], ["\n  // common\n  border-radius: ", ";\n  border: 1px solid transparent;\n  padding: 0 ", ";\n  height: ", "px;\n  font-size: ", ";\n  font-weight: ", ";\n  :disabled {\n    opacity: 0.3;\n    cursor: not-allowed;\n  }\n\n  // default\n  ",
    "\n\n  // primary\n  ",
    "\n\n  // secondary\n  ",
    "\n"])), shape.r8, spacing.s16, function (p) { return p.height; }, typography.size.bt1, typography.weight.bold, function (p) { return p.color === "default" && css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    color: ", ";\n    ", "\n    ", "\n  "], ["\n    color: ", ";\n    ",
    "\n    ",
    "\n  "])), color.label, p.variant === "contained" && css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      background-color: ", ";\n      color: ", ";\n    "], ["\n      background-color: ", ";\n      color: ", ";\n    "])), color.gray10, color.label), p.variant === "outlined" && css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      border-color: ", ";\n      color: ", ";\n    "], ["\n      border-color: ", ";\n      color: ", ";\n    "])), color.label, color.label)); }, function (p) { return p.color === "primary" && css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    color: ", ";\n    ", "\n    ", "\n  "], ["\n    color: ", ";\n    ",
    "\n    ",
    "\n  "])), color.primary, p.variant === "contained" && css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n      background-color: ", ";\n      color: ", ";\n    "], ["\n      background-color: ", ";\n      color: ", ";\n    "])), color.primary, color.white), p.variant === "outlined" && css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      border-color: ", ";\n      color: ", ";\n    "], ["\n      border-color: ", ";\n      color: ", ";\n    "])), color.primary, color.primary)); }, function (p) { return p.color === "secondary" && css(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n    color: ", ";\n    ", "\n    ", "\n  "], ["\n    color: ", ";\n    ",
    "\n    ",
    "\n  "])), color.secondary, p.variant === "contained" && css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      background-color: ", ";\n      color: ", ";\n    "], ["\n      background-color: ", ";\n      color: ", ";\n    "])), color.secondary, color.white), p.variant === "outlined" && css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n      border-color: ", ";\n      color: ", ";\n    "], ["\n      border-color: ", ";\n      color: ", ";\n    "])), color.secondary, color.secondary)); });
